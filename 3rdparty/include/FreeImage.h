...
FI_ENUM(FREE_IMAGE_MDTYPE) {
	...
	FIDT_ASCII		= 2,	// 8-bit bytes w/ last byte nullptr
...
DLL_API FIMEMORY *DLL_CALLCONV FreeImage_OpenMemory(BYTE *data FI_DEFAULT(nullptr), DWORD size_in_bytes FI_DEFAULT(0));
