...
Get the libpng source from http://sourceforge.net/projects/libpng/files/libpng16/1.6.37/lpng1637.7z.
Source files of libjpeg-turbo are required to replace libjpeg in original FreeImage source distribution.
Get the libjpeg-turbo source from http://sourceforge.net/projects/libjpeg-turbo/files/2.0.4/libjpeg-turbo-2.0.4.tar.gz.
...
Get the libpng source from http://sourceforge.net/projects/libpng/files/libpng16/older-releases/1.6.23/lpng1623.7z.
Source files of libjpeg-turbo are required to replace libjpeg in original FreeImage source distribution.
Get the libjpeg-turbo source from http://sourceforge.net/projects/libjpeg-turbo/files/1.5.0/libjpeg-turbo-1.5.0.tar.gz.
...
Get the libpng source from http://sourceforge.net/projects/libpng/files/libpng16/older-releases/1.6.17/lpng1617.7z.
Source files of libjpeg-turbo are required to replace libjpeg in original FreeImage source distribution.
...
Get the libpng source from http://sourceforge.net/projects/libpng/files/libpng16/older-releases/1.6.12/lpng1612.7z.
Source files of libjpeg-turbo are required to replace libjpeg in original FreeImage source distribution.
...
Run "make -f Makefile.ds" (optionally with "-j" to build concurrently) to build the static library.
...
Run "mingw32-make FREEIMAGE_LIBRARY_TYPE=STATIC -f Makefile.mingw" (optionally with "-j" to build concurrently) to build static library for MinGW32.
...
Run "make -f Makefile.gnu libfreeimage.a" (optionally with "-j" to build concurrently) to build static library.
