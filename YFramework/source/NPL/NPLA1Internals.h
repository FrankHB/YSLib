...
MapTypeIdToNumCode(const type_info&) ynothrow;
YB_ATTR_nodiscard YB_PURE inline
...
// TODO: Use bigint.
template<>
struct ExtType<unsigned long long> : ystdex::identity<float>
{};
...
struct NExtType : ystdex::cond_t<std::is_signed<_type>, ExtType<_type>,
	...
	<= ystdex::integer_width<_type>::value), int, long long>>>
{};
...
struct Cast : AssertMismatch<_tDst>
{
	using AssertMismatch<_tDst>::operator();
