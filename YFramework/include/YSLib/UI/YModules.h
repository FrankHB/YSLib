...
#ifndef YSL_INC_UI_YModules_h_
#define YSL_INC_UI_YModules_h_ 1

#include "../../YModules.h"
#include "../Service/YModules.h"
...
//! \since build 494
#define YFM_YSLib_UI_TabControl <YSLib/UI/TabControl.h>
//! \since build 482
